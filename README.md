...
- **App**: `src/app/` - All pages, layouts, and API routes
...
- **USE APP ROUTER ALWAYS** - never Pages Router patterns
...
- Working with App Router (`app-router`)
