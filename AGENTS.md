...
- **api-routes** (scope: app-router): Create and work with Next.js Route Handlers in src/app/api/. Use when creating API endpoints, handling HTTP requests, or working with server-side API logic in App Router.
...
- **components-ui** (scope: stores, testing): Create and organize UI components in src/components/ or src/ui/custom/. Use when creating new custom components, organizing component structure, or working with component exports.
